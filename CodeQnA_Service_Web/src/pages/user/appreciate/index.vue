...
import { reqKnowledgeInfoListByUserIdByAppreciate } from '@/api/knowledge';
...
const fetchData = async () => {
    ...
    let result : PageInfoResponseData = await reqKnowledgeInfoListByUserIdByAppreciate(knowledgeUserDto.value);
    if (result.code === 200) {
