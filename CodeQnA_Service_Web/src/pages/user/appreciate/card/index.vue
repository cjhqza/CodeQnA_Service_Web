        ...
        <el-card class="child-box" shadow="never">
            <div class="content">
                ...
                <div class="right">
                    ...
                    <el-button class="delete-btn" v-if="userStore.userBaseInfo.id === Number($route.query.usercode)" @click="appreciate">取消赞赏</el-button>
                </div>
            </div>
        </el-card>
    </div>
...
import { reqAppreciate } from '@/api/knowledge';
...
const appreciate = () => {
    ElMessageBox.confirm('取消赞赏该贴，是否继续？', 'Warning', {
