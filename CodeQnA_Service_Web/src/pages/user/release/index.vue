...
import { reqKnowledgeListByUserIdByRelease } from '@/api/knowledge';
...
const fetchData = async () => {
    ...
    let result : PageInfoResponseData = await reqKnowledgeListByUserIdByRelease(knowledgeUserDto.value);
    if (result.code === 200) {
