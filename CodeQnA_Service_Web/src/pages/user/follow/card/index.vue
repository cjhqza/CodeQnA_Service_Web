        ...
        <el-card class="child-box" shadow="never">
            <div class="content">
                ...
                <div class="right">
                    ...
                    <el-button class="delete-btn" v-if="userStore.userBaseInfo.id === Number($route.query.usercode)" @click="follow">取消收藏</el-button>
                </div>
            </div>
        </el-card>
    </div>
...
import { reqFollow } from '@/api/knowledge';
import { CommonResponseData } from '@/api/user/type';
...
const follow = () => {
    ElMessageBox.confirm('取消收藏该贴，是否继续？', 'Warning', {
